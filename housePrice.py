...
# df[na_cols].fillna("No",inplace=True)
...
drop_list = ["Street", "Alley", "LandContour", "Utilities", "LandSlope", "Condition2", "Heating", "PoolQC", "MiscFeature", "KitchenAbvGr",
             "BedroomAbvGr", "RoofMatl", "FireplaceQu","RoofStyle", "ExterQual", "Electrical", "Functional", "FireplaceQu", "Neighborhood"]
